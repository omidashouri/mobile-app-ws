...
public class AuthorizationFilter extends BasicAuthenticationFilter {
    ...
    //    we should implements this method when extending BasicAuthenticationFilter
...
//    read header and get token and parse the token and decrypt it and get the user detail
